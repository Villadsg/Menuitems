<script lang="ts">
  ...
  {#if page === 'home'}
    <div class="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md mt-8">
      <h1 class="text-2xl font-bold text-gray-700 mb-4">Find the Closest Monument</h1>
      <button class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600" on:click={findLocation}>Find My Location</button>
