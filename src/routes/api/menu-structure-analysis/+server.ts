...
/**
 * POST handler for Menu Structure Analysis using Mistral LLM
 */
export const POST: RequestHandler = async ({ request }) => {
  try {
    ...
    console.error('Menu structure analysis error:', error instanceof Error ? error.message : 'Unknown error');
