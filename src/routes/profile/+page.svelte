...
<div class="flex justify-center items-center min-h-screen">
  <div class="text-center">
      ...
      <div class="mt-4">
          <label for="langLearn" class="block">Select Language for Learning:</label>
      ...
      <div class="mt-4">
          <label for="langSpeak" class="block">Select Language for Speaking:</label>
      ...
      <button 
          ...
          on:click={saveLanguages}>
          Save Changes
      </button>

      <!-- Navigate to Edit Tours -->
      <button 
          class="btn btn-primary mt-4" 
